...
public class Player extends DressedEntity implements UseListener {
	...
	public void setDisguise(final String slotName, final String itemName) {
        String acceptedSlot = "armor";
        String acceptedName = "black armor";
        // checks if the item in the armor slot is the disguise armor
        if (slotName.equals(acceptedSlot)&& itemName.equals(acceptedName)) {
            setInvisible(true);
        }
