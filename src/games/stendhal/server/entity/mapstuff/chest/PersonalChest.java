...
public class PersonalChest extends Chest {
	...
	public void setAttending(RPEntity player) {
		this.attending = player;
	} // since attending is always null and cannot be used by other entity, this will set attending to the current player accessing travel log
	/**
